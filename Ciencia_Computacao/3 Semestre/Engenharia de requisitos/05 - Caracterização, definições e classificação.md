...
2. **[[07 - O Processo Completo de Vida do Requisito|Gerência de Requisitos]]**.
...
- **Etapas Sequenciais (Produção):**
	...
	3. **Definição e especificação dos Requisitos** (Documentação).
...
A norma ISO/IEC 25010 (substituindo a ISO/IEC 9126) define 8 características principais de [[06 - Qualidade de Software e norma ISO 25000|qualidade de software]]:
...
- **Exemplo (RD):** O sistema deve cadastrar nome, endereço, e-mail, telefone do cliente.
